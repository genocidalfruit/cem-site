...
const Carousel = () => {
  ...
  return (
    <section
      className="relative mt-25 md:mt-24 px-2 sm:px-4 py-8 inset-shadow-sm inset-shadow-gray-600/50 sm:py-16 text-center rounded-lg mx-2 sm:mx-4 md:mx-8 bg-center bg-no-repeat"
      style={{

    ...
    <header className="bg-gradient-to-r from-slate-50 to-gray-50 border-b-2 border-yellow-500/20 px-8 py-4 sticky top-0 z-50 shadow-sm">
      <div className="flex justify-between items-center max-w-6xl mx-auto">
        ...
        <div className="flex items-center gap-4">
          <button className="hidden md:flex items-center gap-2 bg-gradient-to-r from-yellow-500 to-yellow-600 text-white px-6 py-2.5 rounded-full font-semibold text-sm shadow-lg hover:shadow-xl hover:from-yellow-600 hover:to-yellow-700 transition-all duration-300 transform hover:scale-105">
            Get in Touch
          </button>
          ...
          <div className="max-h-80 overflow-y-auto scrollbar-thin scrollbar-track-gray-100 scrollbar-thumb-yellow-300 hover:scrollbar-thumb-yellow-400">
            <div className="p-4 space-y-2">
              ...
              <div className="pt-3 mt-4">
                <button className="w-full bg-gradient-to-r from-yellow-500 to-yellow-600 text-white py-3 rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all duration-300">
                  Get in Touch
                </button>
              </div>
            </div>

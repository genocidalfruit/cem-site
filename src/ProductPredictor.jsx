...
const ProductPredictor = () => {
  ...
  return (
    ...
    style={{
      ...
      <Header />
      <div className="flex-grow border-t border-gray-300/20 rounded-md bg-gray-100/75 mt-28 mx-10 mb-10 shadow-2xl shadow-gray-600/50">
        <h1 className="text-xl xs:text-2xl sm:text-3xl md:text-5xl font-extrabold text-center flex flex-wrap sm:flex-nowrap items-center justify-center gap-x-3 gap-y-2 border-b border-gray-300 pb-6 sm:pb-10 mt-8 px-2">
